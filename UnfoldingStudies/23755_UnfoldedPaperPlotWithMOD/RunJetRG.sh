...
./Execute --Input Input/DataJetRGNominal.root \
   ...
   --MCFile "Input/DataJetRGNominal.root","OriginalInput/MCPythia8JetRG.root","OriginalInput/MCVincia1JetRG.root",OriginalInput/MCVincia2JetRG.root,OriginalInput/MCJetScapeJetRG.root \
   --MCHistogram HMCTruth,HMCGen,HMCGen,HMCGen,HMCGen \
...
./Execute --Input Input/DataJetRGNominal.root \
   --Systematic Systematics/DataJetRGNormalized.root --Output Plots/DataJetRGNominal.pdf --FinalOutput Plots/MeowRGJetScape.${Format} \
   --RootOutput Root/DataJetRGNominalPythia.root \
   --MCFile "Input/DataJetRGNominal.root","OriginalInput/MCPythia8JetRG.root",OriginalInput/MCJetScapeJetRG.root,OriginalInput/MCJetScapeBypassJetRG.root,OriginalInput/MCJetScapeSmashJetRG.root,OriginalInput/MCJetScapeLHEJetRG.root \

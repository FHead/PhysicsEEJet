...
./Execute --Input Input/DataJetMENominal.root \
   ...
   --MCFile "Input/DataJetMENominal.root","OriginalInput/MCPythia8JetME.root","OriginalInput/MCVincia1JetME.root",OriginalInput/MCVincia2JetME.root,Input/DataJetMETighter.root \
   --MCHistogram HMCTruth,HMCGen,HMCGen,HMCGen,HUnfoldedBayes7 \
   --MCLabel "PYTHIA 6","PYTHIA 8","P8 Shower 1","P8 Shower 2","Tighter" \
   --PrimaryName HUnfoldedBayes7 \
   --DoSelfNormalize true \
   --GenPrimaryMin 0 --GenPrimaryMax 0.5 \
